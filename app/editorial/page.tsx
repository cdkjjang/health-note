  ...
  return (
    <div className="space-y-6 text-[15px] leading-relaxed">
      ...
      <section className="space-y-3">
        ...
        <p>
          건강보험 기준값은 해마다 바뀝니다. 본인부담상한액은 매년 1월 전국
          소비자물가변동률을 반영해 고시되고, 건강보험료율과 장기요양보험료율도
          연초에 정해집니다. 피부양자 소득·재산 요건은 시행규칙 개정 때 움직이는데,
          2022년 개편에서 소득 기준이 3,400만원에서 2,000만원으로 내려간 적이
          있습니다. <strong>이런 값은 바뀌어도 눈에 잘 띄지 않습니다.</strong>{" "}
          그래서 고시값 자체를 숫자로 고정하는 검증 테스트를 따로 두어, 값이 낡으면
          조용히 통과하지 않고 먼저 실패하게 했습니다.
        </p>
        <p>
