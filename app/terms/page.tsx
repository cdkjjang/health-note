  ...
  return (
    <div className="space-y-6 text-[15px] leading-relaxed">
      ...
      <section className="space-y-3">
        ...
        <p>
          {SITE_NAME}는 피부양자 자격·본인부담상한제 환급·건강검진 대상·병원비
          본인부담률 등 건강보험 제도와 관련된 계산기와 정보 콘텐츠를 무료로
          제공하는 서비스입니다. 회원가입 없이 누구나 이용할 수 있습니다.
        </p>
      </section>
      ...
      <section className="space-y-3">
        ...
        <p>
          본 사이트의 계산 결과와 콘텐츠는 국민건강보험법과 같은 법 시행령·
          시행규칙, 국민건강보험공단 고시 등 공개된 기준을 정리한
          <strong> 일반적인 참고 정보이며, 의료·법률 자문이 아닙니다</strong>.
          특히 피부양자 자격 판정과 본인부담상한제 환급은 공단이 부양요건과
          소득분위를 개별로 산정해 최종 결정하므로, 본 사이트의 결과와 다를 수
          있습니다.
        </p>
        <p>
          운영자는 정보의 정확성을 위해 노력하지만, 본 사이트의 정보를 근거로 한
          의사결정의 결과에 대해 법적 책임을 지지 않습니다. 확정 사항은 국민건강
          보험공단(1577-1000)에서 확인하시기 바랍니다.
        </p>
      </section>
